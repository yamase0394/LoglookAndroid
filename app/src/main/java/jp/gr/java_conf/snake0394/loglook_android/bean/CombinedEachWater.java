...
/**
 * Created by snake0394 on 2016/11/19.
 */

public class CombinedEachWater extends Battle{
    private BattleType battleType = BattleType.COMBINED_EACH_WATER;
     ...
     * 敵艦船。[0]=-1、[1]～[6]=敵艦船id
     */
    private List<Integer> eShipCombined;
     ...
     * 敵艦船のレベル。[0]=-1、[1]～[6]=レベル
     */
    private List<Integer> eShipLvCombined;
    ...
    /**
     * 第2艦隊の現在hp。[0]=-1、[1]～[6]=味方hp、[7]～[12]=敵hp
     */
    private List<Integer> nowhpsCombined;

    /**
     * 第2艦隊の最大hp。[0]=-1、[1]～[6]=味方hp、[7]～[12]=敵hp
     */
     ...
     * [0]=-1,[1]～[6]=敵が受けたダメージ。
     */
    private List<Integer> koukuEnemyDamageCombined = null;
    ...
    private List<Integer> HougekiAtEFlagList1 = null;

    /**
     * 砲撃戦の行動順
     * サイズは砲撃戦の回数。
     * 格納されているリスト[0]=-1,それ以降は行動順に。敵味方の識別はHougekiAtEflagで
     */
    ...
    private List<Integer> HougekiAtEFlagList2 = null;
    ...
    private List<Integer> HougekiAtEFlagList3 = null;
    ...
    public List<Integer> geteShipCombined() {
        return eShipCombined;
    }

    public void seteShipCombined(List<Integer> eShipCombined) {
        this.eShipCombined = eShipCombined;
    }
    ...
    public List<Integer> geteShipLvCombined() {
        return eShipLvCombined;
    }

    public void seteShipLvCombined(List<Integer> eShipLvCombined) {
        this.eShipLvCombined = eShipLvCombined;
    }
    ...
    public List<List<Integer>> getBaseEnemyDamageCombined() {
        return baseEnemyDamageCombined;
    }

    public void setBaseEnemyDamageCombined(List<List<Integer>> baseEnemyDamageCombined) {
        this.baseEnemyDamageCombined = baseEnemyDamageCombined;
    }
    ...
    public List<Integer> getKoukuEnemyDamageCombined() {
        return koukuEnemyDamageCombined;
    }

    public void setKoukuEnemyDamageCombined(List<Integer> koukuEnemyDamageCombined) {
        this.koukuEnemyDamageCombined = koukuEnemyDamageCombined;
    }
    ...
    public List<Integer> getHougekiAtEFlagList1() {
        return HougekiAtEFlagList1;
    }

    public void setHougekiAtEFlagList1(List<Integer> hougekiAtEFlagList1) {
        HougekiAtEFlagList1 = hougekiAtEFlagList1;
    }
    ...
    public List<Integer> getHougekiAtEFlagList2() {
        return HougekiAtEFlagList2;
    }

    public void setHougekiAtEFlagList2(List<Integer> hougekiAtEFlagList2) {
        HougekiAtEFlagList2 = hougekiAtEFlagList2;
    }
    ...
    public List<Integer> getHougekiAtEFlagList3() {
        return HougekiAtEFlagList3;
    }

    public void setHougekiAtEFlagList3(List<Integer> hougekiAtEFlagList3) {
        HougekiAtEFlagList3 = hougekiAtEFlagList3;
    }
    ...
    public void set(String jsonStr) {
        try {
            ...
            shipLv = battledata.getJSONArray("api_ship_lv_combined");
            tIntList = new ArrayList<>();
            for (int i = 0; i < shipLv.length(); i++) {
                tIntList.add(shipLv.getInt(i));
            }
            seteShipLvCombined(tIntList);

            JSONArray shipKeCombined = battledata.getJSONArray("api_ship_ke_combined");
            tIntList = new ArrayList<>();
            for (int i = 0; i < shipKeCombined.length(); i++) {
                tIntList.add(shipKeCombined.getInt(i));
            }
            seteShipCombined(tIntList);
            ...
            if (battledata.has("api_air_base_attack")) {
                ...
                List<List<Integer>> tIntListListCombined = new ArrayList<>();
                for (int i = 0; i < airBaseAttack.length(); i++) {
                    ...
                    stage3 = obj.getJSONObject("api_stage3_combined");
                    edam = stage3.getJSONArray("api_edam");
                    tIntList = new ArrayList<>();
                    for (int j = 0; j < edam.length(); j++) {
                        tIntList.add(edam.getInt(j));
                    }
                    tIntListListCombined.add(tIntList);
                }
            ...
            if (battledata.getJSONArray("api_stage_flag").getInt(2) == 1) {
                ...
                setKoukuEnemyDamageCombined(tIntList);
            }
            ...
            if (houraiFlag.getInt(0) == 1) {
                ...
                JSONArray eflag = hougeki1.getJSONArray("api_at_eflag");
                tIntList = new ArrayList<>();
                for (int i = 1; i < eflag.length(); i++) {
                    tIntList.add(eflag.getInt(i));
                }
                setHougekiAtEFlagList1(tIntList);
            ...
            if (houraiFlag.getInt(1) == 1) {
                ...
                setHougekiAtEFlagList2(tIntList);
            ...
            if (houraiFlag.getInt(2) == 1) {
                ...
                setHougekiAtEFlagList3(tIntList);
